...
var a = document.getElementById('counter'), b = parseInt(a.innerText);a.innerText = b + 1;
  }, 1e3);}, interval = timer(), minus = document.getElementById('-'), plus = document.getElementById('+'), heart = document.getElementById('<3'), pause = document.getElementById('pause'), commentForm = document.getElementsByTagName('form')[0];minus.addEventListener('click', function () {
var a = document.getElementById('counter'), b = parseInt(a.innerText);a.innerText = b - 1;
